...
# 🏛️ Guía Estándar de Arquitectura para Aplicaciones de Escritorio (Desktop Apps) — Ely-Tesia
...
- **Prohibición**: Queda estrictamente prohibido forzar que la ventana se reinicie siempre en un tamaño fijo predeterminado o en modo flotante sin recordar si el usuario la maximizó o personalizó en su sesión previa.
